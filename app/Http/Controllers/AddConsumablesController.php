...
class AddConsumablesController extends Controller
{
    ...
    {
        return view('AddConsumables.view');
    }
         ...
         'file' => 'mimes:pdf,jpeg,png,bmp,gif|max:2048|nullable',
           ...
           $insert['file'] = "$recite_copy";
            ...
            if($files)
            {
                ...
                $consumables ->save();
                return redirect()->back()->with('success','The consumables details were successfully added to the database!!');  
