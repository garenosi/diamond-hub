                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="text-container">
                            <h1><span class="turquoise">Create New</span> Department </h1>
                    ...
                    <!-- Actually form being used -->
                     <form method="POST" action="{{ route('add_department') }}" style="border-radius: 20px;" enctype="multipart/form-data">
                                 @csrf
                                <div class="row">
                                    ...
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12"><small>Department Name</small>
                                        <input class="form-control"  type="text" name="dept_name" required>
                                    </div>

                                     <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12"><small>Manager Name</small>
                                        <input class="form-control"  type="text" name="manager" required>
                                    </div>
                                    

                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12"><small>Location</small>
                                        <input class="form-control"  type="text" name="location" required>
                                    </div>


                                   
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12"><small>Select File *</small>
