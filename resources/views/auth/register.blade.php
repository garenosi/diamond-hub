                ...
                <div class="row">
                    <div class="col-lg-5">
                        <div class="text-container">
                            <h1><span class="turquoise">Register Form</span> </h1>
                    ...
                    <!-- Actually form being used -->
                     <form method="POST" action="{{ route('users.store') }}" id="requestForm"  data-focus="false">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-12">
                                <input id="name" type="text" class="form-control-input" placeholder="Full Names" name="name" value="{{ old('name') }}" required autofocus>
