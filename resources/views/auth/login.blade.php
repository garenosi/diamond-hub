                ...
                <div class="row">
                    <div class="col-lg-5">
                         ...
                         <div class="text-container">
                            ...
                            <p class="p-large">We make asset management services easier and user friendly. Tracking and tracing of how assets are allocated at the finger tip!</p>
                            <a class="btn-solid-lg page-scroll" href="#">Login Form Below <i class="fa fa-arrow-down"></i></a>
                    ...
                    <div class="form-container">
                        ...
                        <form method="POST" action="{{ route('login') }}" id="requestForm"  data-focus="false" style="display: none;">
                        @csrf
                    ...
                    <!-- Actually form being used -->
                     <form method="POST" action="{{ route('login') }}" id="requestForm"  data-focus="false" style="margin-top: -40px;">
                        @csrf

                     

                        <input id="name" type="hidden" class="form-control-input" value="customer" name="user_role" value="{{ old('user_role') }}" required autofocus>
