...
<head>
    ...
    <title>Online Passport Registration</title>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav" style="background-color: white">
                        ...
                        @else
                            ...
                            <li class="nav-item">
                               <a class="nav-link" href="/ViewPassport.view" >Process applications</a> 
                              </li>
                             
                              <li class="nav-item">
                               <a class="nav-link" href="#" >View inquries</a> 
                              </li>
                                <li class="nav-item">
                               <a class="nav-link" href="/CollectPassport.view" >Successful applications</a> 
                              </li>
