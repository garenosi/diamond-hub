                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="text-container">
                            <h1><span class="turquoise">Create New</span> Component</h1>
                    ...
                    <!-- Actually form being used -->
                     <form method="POST" action="{{ route('add_component') }}" style="border-radius: 20px;" enctype="multipart/form-data">
                                 @csrf
                                <div class="row">
                                    ...
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12"><small>Component Name</small>
                                        <input class="form-control"  type="text" name="component_name" required>
                                    </div>
