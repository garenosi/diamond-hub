                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="text-container">
                            <h1><span class="turquoise">Create Staff</span> </h1>
                            <p class="p-large">Fill in all the fields below to create staff member record</p>
                           
                        </div> <!-- end of text-container -->

                          <!-- Actually form being used -->
                    <!-- Actually form being used -->
                     <form method="POST" action="{{ route('users.store') }}" style="border-radius: 20px;" enctype="multipart/form-data">
                                 @csrf
                                <div class="row">

                                     <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12"><small>First Name</small>
                                        <input class="form-control"  type="text" name="f_name" required>
                                    </div>

                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12"><small>Last Name</small>
                                        <input class="form-control"  type="text" name="l_name" required>
                                    </div>

                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12"><small>Email</small>
                                        <input class="form-control"  type="email" name="email" required>
                                    </div>

                                     <input class="form-control"  type="hidden" name="user_role" value="staff">

                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12"><small>Password</small>
                                        <input class="form-control"  type="password" name="password" required>
                                    </div>

                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12"><small>Confirm Password</small>
                                        <input class="form-control"  type="password" name="con_password" required>
                                    </div>
                                    ...
                                    <option class="select-option" value="Company 2 ">Company 1 </option>
                                   ...
                                   <br>
                                    ...
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12"><small>Profile Photo *</small>
