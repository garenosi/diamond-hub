                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="text-container">
                            <h1><span class="turquoise">Create Asset</span> </h1>
                    ...
                    <!-- Actually form being used -->
                     <form method="POST" action="{{ route('add_asset') }}" style="border-radius: 20px;" enctype="multipart/form-data">
                                 @csrf
                                <div class="row">
                                    ...
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12"><small>Asset Tag</small>
                                        <input class="form-control"  type="text" name="asset_tag" required>
                                    </div>

                                     <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12"><small>Asset Name</small>
                                        <input class="form-control"  type="text" name="asset_name" required>
                                    </div>
                                    

                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12"><small>Serial No.</small>
                                        <input class="form-control"  type="text" name="serial_no" required>
                                    </div>


                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12"><small>Model</small>
                                        <select class="form-control" id="rselect" name="model" required>
                                            <option class="select-option" value="" disabled selected>-- Select Model --</option>
                                            <option class="select-option" value="Model 1 ">Model 1 </option>
                                            <option class="select-option" value="Model 2 ">Model 1 </option>
                                            <option class="select-option" value="Model 3 ">Model 3 </option>
                                            <option class="select-option" value="Model 4 ">Model 4 </option>
                                        </select>
                                    </div>

                                     <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12"><small>Status</small>
                                        <select class="form-control" id="rselect" name="status" required>
                                            <option class="select-option" value="" disabled selected>-- Select Status --</option>
                                            <option class="select-option" value="Status 1 ">Status 1 </option>
                                            <option class="select-option" value="Status 2 ">Status 1 </option>
                                            <option class="select-option" value="Status 3 ">Status 3 </option>
                                            <option class="select-option" value="Status 4 ">Status 4 </option>
                                        </select>
                                    </div>

                                     <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12"><small>Supplier</small>
                                        <select class="form-control" id="rselect" name="supplier" required>
                                            <option class="select-option" value="" disabled selected>-- Select Supplier --</option>
                                            <option class="select-option" value="Supplier 1 ">Supplier 1 </option>
                                            <option class="select-option" value="Supplier 2 ">Supplier 2 </option>
                                            <option class="select-option" value="Supplier 3 ">Supplier 3 </option>
                                            <option class="select-option" value="Supplier 4 ">Supplier 4 </option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">Order No.</small>
                                        <input class="form-control" step=".01" type="number" name="order_no" required>
                                    </div>

                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">Warranty (No. of months)</small>
