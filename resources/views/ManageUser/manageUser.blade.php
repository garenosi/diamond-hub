                ...
                <div class="row" style="margin-top: -100px;">
                    <div class="col-lg-6">
                        <div class="text-container">
                            <h1><span class="turquoise">Staff</span> Members</h1>
                            <p class="p-large">Below is a list of all staff members and the companies they belong to.</p>
                       ...
                       <table class="table tabel-hover table bordered" style="border-radius: 9px; background-color: white;width: 100%;"> 
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td width="180"><a class="nav-link page-scroll" style="float: left;margin-right: 4px;" title="Click here to reset password" href="{{ route('logout') }}"
                                       ><i class="fa fa-lock"></i></a> 

                                       <a class="nav-link page-scroll" title="Click here to edit user details" style="float: left;margin-right: 4px;" href="{{ route('logout') }}"
                                       onclick="event.preventDefault();
                                                     document.getElementById('logout-form').submit();"><i class="fa fa-edit"></i></a>


                                     <a class="nav-link page-scroll" title="Click here to delete user permanently" style="float: left;margin-right: 1px;" href="{{ route('logout') }}"
                                       onclick="event.preventDefault();
