        ...
        <div class="header-content">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <!-- Actually form being used -->
                     <form method="POST" action="{{ route('add_accessory') }}" style="border-radius: 20px;" enctype="multipart/form-data">
                                 @csrf
                                <div class="row">
                                    ...
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12"><small>Accessory Name</small>
